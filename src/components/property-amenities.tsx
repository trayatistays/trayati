...
export function PropertyAmenities({
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4">
          {amenitiesList.map((amenity) => (
            <motion.div
              ...
              style={{
                background: "linear-gradient(135deg, rgba(164,108,43,0.08), rgba(164,108,43,0.03))",
                borderColor: "rgba(164,108,43,0.2)",
      ...
      <div>
        <h3
          className="mb-6 flex items-center gap-2 font-display text-xl font-bold"
          style={{ color: "var(--foreground)" }}
        >
          <svg
            className="h-5 w-5"
        ...
        >
          {activeAmenities.map(([key]) => (
            <motion.div
              ...
              style={{
                backgroundColor: "rgba(74,101,68,0.05)",
            ...
            >
              ...
              <span className="text-center text-xs font-semibold capitalize">
                {key
                  .replace(/([A-Z])/g, " $1")
                  .trim()
                  .toLowerCase()}
