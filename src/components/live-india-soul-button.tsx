  ...
  return (
    <motion.button
      ...
      style={{
        ...
        boxShadow: "0 16px 36px rgba(74, 101, 68, 0.08)",
      }}
      aria-label="Open Live India Soul experience selector"
    >
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(135deg,rgba(164,108,43,0.14),transparent_45%,rgba(13,58,82,0.14))] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
      ...
      <motion.div
        ...
        style={{ backgroundColor: "rgba(164, 108, 43, 0.12)" }}
      >
      ...
      <div className="absolute inset-0 -z-10 rounded-full border opacity-0 transition-opacity duration-300 group-hover:opacity-100" style={{ borderColor: "rgba(164, 108, 43, 0.3)" }} />
    </motion.button>
  );
}
